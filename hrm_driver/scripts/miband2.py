...
# slightly modified version of https://github.com/vshymanskyy/miband2-python-test
...
class AuthenticationDelegate(DefaultDelegate):
    ...
    def __init__(self, device):
        ...
        self.device = device
        self.pub = rospy.Publisher("/hrm/miband2", HrmData, queue_size=1)
...
def main():
    ...
    rospy.init_node("miband2_hrm_node")

    """ main func """

    mac = rospy.get_param("~mac", "E4:B0:97:E7:6E:72")
    ...
    if arg.notify:
        ...
        time.sleep(arg.t)
        print("Sending phone notification...")  # TODO notification on service call
